...
% Title name
\namesection{张}{家铭}{
\phone{155 4328 6223} \email{
    \href
    {mailto:Jmzhang@bjfu.edu.cn}
    {Jmzhang@bjfu.edu.cn}}
    }
...
\subsection{北京林业大学}
\descript{工学硕士 - 林业装备与信息化}
\cvevent{Sep 2021}{北京, 中国} 
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
\item 研究生学业一等奖学金 $\times 3$
\item 优秀研究生
\item 机器视觉助教
\item 班级委员会成员
\end{tightemize}
...
\subsection{中国矿业大学(北京)}
\descript{理学学士 - 信息与计算科学}
\cvevent{Sep 2016}{北京, 北京} 
\sectionsep
...
\subsection{均分：93/100}
\subsection{排名：4/128(学硕第1名)}
Data Science \\
...
\runsubsection{Machine Learning Intern实习} \\
